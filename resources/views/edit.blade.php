        ...
        <div class="row">
            <div class="">
                <div class="contact-form">
                    ...
                    <form method="POST" action="{{ route('sendedit') }}">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                                <input  name="id" class="form-control" id="inputName" type="hidden" value="{{ $infos->id }}">
                                <div class="form-group">
                                    <label for="inputName">Nom de L'appareil</label>
                                    <input type="text" name="NomAppareil" class="form-control" id="inputName" required value="{{ $infos->NameApp }}" >
                                </div>
                            </div>                
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="inputEmail">Nom de client</label>
                                    <input type="text" class="form-control" id="inputEmail" required name="Name" value="{{ $infos->Name }}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="inputPhone">Ville</label>
                                    <input type="text" class="form-control" id="inputPhone" required name="ville" value="{{ $infos->Ville }}">
                                </div>
                            </div>
                        </div>      
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputName" required name="numero" value="{{ $infos->Numero }}">
                                </div>
                            </div>     
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="inputName">email</label>
                                    <input type="email" class="form-control" id="inputName" required name="email" value="{{ $infos->email }}">
                                </div>
                            </div>               
                            <div class="col-sm-4">
                                <div class="form-group">
